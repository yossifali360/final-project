...
export const CheckOutSchema = Yup.object().shape({
    AuctionAmount : Yup.number().typeError("Enter a Valid Price").required("Price is required").min(10000, "Auction Amount cannot be less Than 100,000"),
    ...
    usedPhone : Yup.number().typeError("Enter a Valid Phone Number").required("Phone Number is required"),
