		...
		<>
			{Loading ? (
				...
				<div className="container m-auto flex relative">
					...
					<div className="hidden dark:block absolute mainGradient top-48 right-0 w-44	h-44"></div>
						...
						<div className="addPhoto m-auto px-3 bg-gray-100 dark:bg-slate-900 py-1">
							{console.log(
								SessionData &&
									...
									SessionData.userData.Role === "Partner"
							)}
							{SessionData &&
							SessionData.userData &&
							SessionData.userData.Role === "Partner" ? (
				...
				focus:outline-none focus:border-sky-500 focus:ring-1 dark:border-gray-700 focus:ring-sky-500"
								...
								<>
									<h3 className="text-center text-3xl py-2 dark:text-white">
										Our Partners Posts
									</h3>
									<SeachPosts setposts={setposts} />
								</>
							)}
