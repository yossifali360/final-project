...
export const PostDiv = ({header,text,images,id}) => {
  ...
  return (
    ...
    <div className="flex items-center justify-center gap-3">
      <a href={whatsLink} target='_Blank' className="flex justify-center items-center px-3 w-1/2 py-2 text-sm font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
